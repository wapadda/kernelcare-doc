...
[Link Add-ons Directly](/whmcs_plugin/#link-add-ons-directly) (for WHMCS 7.2.x and later)
...
Configure CloudLinuxLicenses product as described [here](/whmcs_plugin/#configuration-of-product) .
